...
export default function RoutesPage() {
  ...
  useEffect(() => { async function load() { const { data } = await supabase.auth.getUser(); if (data.user) setRoutes(await getSupplierEntities<Route>('routes', data.user.id)); setLoading(false) } load() }, [])
