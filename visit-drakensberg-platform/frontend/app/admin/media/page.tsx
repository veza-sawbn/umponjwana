...
export default function AdminMediaPage() {
  ...
  async function remove(id: string) { await deleteAdminMedia(id); setMedia(m => m.filter(item => item.id !== id)) }
