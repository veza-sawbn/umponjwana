...
const POSTS = [
  { id: 'p1', title: 'The Ancient Art of the San Bushmen', slug: 'san-bushmen-rock-art', category: 'Heritage', author: 'Lerato Sithole', status: 'published', published: '10 Jun 2026', views: 1240 },
  { id: 'p2', title: 'Climbing the Chain Ladder: A First-Timer\'s Guide', slug: 'chain-ladder-guide', category: 'Hiking Stories', author: 'Sipho Dlamini', status: 'published', published: '5 Jun 2026', views: 2180 },
  { id: 'p3', title: 'The Bearded Vulture: Drakensberg\'s Rarest Resident', slug: 'bearded-vulture-drakensberg', category: 'Wildlife', author: 'Anele Mokoena', status: 'published', published: '28 May 2026', views: 890 },
  { id: 'p4', title: 'Hidden Waterfalls of Champagne Valley', slug: 'champagne-valley-waterfalls', category: 'Hiking Stories', author: 'Thabo Ndlovu', status: 'draft', published: null, views: 0 },
  { id: 'p5', title: 'A Week in the Southern Drakensberg', slug: 'southern-berg-itinerary', category: 'Culture', author: 'Admin', status: 'draft', published: null, views: 0 },
]
      ...
      <div className="bg-white border border-gray-200 overflow-hidden">
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {posts.map(post => (
              <tr key={post.id} className="hover:bg-[#F7F5F2] transition-colors">
