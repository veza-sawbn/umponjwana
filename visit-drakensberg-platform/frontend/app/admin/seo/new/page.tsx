...
const TEMPLATES: Record<PageType, BriefTemplate> = {
  ...
  destination: {
    ...
    sections: [
      ...
      { label: 'When to visit', description: 'Seasonal guide: best months for hiking, swimming, birding and photography.', required: true },
    ...
    internalLinkSuggestions: [
      '/regions, the regions listing page',
  ...
  property: {
    ...
    internalLinkSuggestions: [
      '/stays, the accommodation listing page',
      '/regions/{regionSlug} — destination parent page',
  ...
  activity: {
    ...
    sections: [
      ...
      { label: 'What\'s included', description: 'Equipment, guide, meals and transfers: what the price covers.', required: true },
    ...
    internalLinkSuggestions: [
      '/activities, the activities listing page',
      '/regions/{regionSlug} — destination parent page',
      '/stays?region={region} — accommodation for activity guests',
      '/guides, the operator profile page',
  ...
  package: {
    ...
    sections: [
      ...
      { label: "What's included", description: 'Accommodation, meals, activities, transfers and guide, itemised.', required: true },
    ...
    internalLinkSuggestions: [
      '/packages, the packages listing page',
  ...
  article: {
    ...
    internalLinkSuggestions: [
      '/mydrakensberg, the editorial home',
