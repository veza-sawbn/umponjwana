          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-white border border-gray-200 p-5 flex items-center justify-between gap-4 flex-wrap">
                  <div>
                    <p className="font-display italic text-lg text-[#000000] mb-0.5">Cannibalisation Detector</p>
                    <p className="font-sans text-sm text-gray-500">
                      Find entity pairs competing for the same search intent — Jaccard similarity + topic conflicts.
                    </p>
                  </div>
                  <Link
                    href="/admin/seo/overlap"
                    className="shrink-0 border border-[#2d6a4f] text-[#2d6a4f] px-5 py-2.5 font-sans text-sm hover:bg-[#2d6a4f] hover:text-white transition-colors"
                  >
                    View overlap report →
                  </Link>
                ...
                <div className="bg-white border border-gray-200 p-5 flex items-center justify-between gap-4 flex-wrap">
                  <div>
                    <p className="font-display italic text-lg text-[#000000] mb-0.5">Page Quality Checklist</p>
                    <p className="font-sans text-sm text-gray-500">
                      Run automated SEO checks and a manual review checklist before publishing any entity.
                    </p>
                  </div>
                  <Link
                ...
                <div className="bg-white border border-gray-200 p-5 flex items-center justify-between gap-4 flex-wrap">
                  <div>
                    <p className="font-display italic text-lg text-[#000000] mb-0.5">Related Entity Manager</p>
                    <p className="font-sans text-sm text-gray-500">
                      Add and remove explicit internal links between trails, stays, and activities for related-content sections.
                    </p>
                  </div>
                  <Link
                    href="/admin/seo/related"
                    className="shrink-0 border border-[#2d6a4f] text-[#2d6a4f] px-5 py-2.5 font-sans text-sm hover:bg-[#2d6a4f] hover:text-white transition-colors"
                  >
