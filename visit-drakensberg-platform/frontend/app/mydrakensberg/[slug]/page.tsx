...
const ARTICLES: Record<string, HardcodedArticle> = {
  ...
  'bearded-vulture-lammergeier': {
    ...
    excerpt: "The lammergeier, or bone-breaker, is one of the most extraordinary birds on the planet. The Drakensberg is its last South African stronghold.",
    category: 'Wildlife',
    ...
    body: [
      ...
      { text: "In the breeding season (May–August), pairs display together over the escarpment ridge in long, slow, parallel soaring flights that can last hours. Nest sites are on inaccessible cliff ledges; if you see a large bird repeatedly visiting a particular section of cliff between May and August, watch from a distance and do not approach." },
    ],
    relatedListings: [
      { title: "Giant's Castle Rest Camp", type: 'Stay', href: '/stays', image: 'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?w=400&q=80', location: "Giant's Castle, Central Berg" },
