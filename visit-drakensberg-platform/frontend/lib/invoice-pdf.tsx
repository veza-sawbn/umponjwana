...
// The wordmark and the registered-identity defaults are shared with the
// supplier agreement PDF (lib/pdf-letterhead.tsx) so both carry the same
// company identity. Re-exported here because the invoice route imports
// BUSINESS_DETAILS_DEFAULTS from this module.
